...
const Technologies = () => {
  const renderIcon = (iconName, color) => {
    ...
    switch (iconName) {
      ...
      case 'linkedin':
        return (
          <svg {...iconProps} viewBox="0 0 24 24" style={{ fill: '#0077B5' }}>
      ...
      case 'pinterest':
        return (
          <svg {...iconProps} viewBox="0 0 24 24" style={{ fill: '#E60023' }}>
      ...
      default:
        return <div className="w-8 h-8 bg-primary rounded-full flex items-center justify-center text-white text-sm font-bold">?</div>
    }
  }
  ...
  const technologies = [
    ...
    // Design & Créatifs
    {
      ...
      items: [
        ...
        { name: "Photoshop", description: "Notions de base", icon: "photoshop", color: "#31A8FF" },
    ...
    // Outils IA
    {
      ...
      items: [
        ...
        { name: "Copy.ai", description: "Rédaction marketing IA", icon: "copyai", color: "#00A67E" },
        { name: "Ad Creative.ai", description: "Création publicitaire IA", icon: "adcreative", color: "#FF6B35" },
        { name: "Brand Watch", description: "Monitoring de marque", icon: "brandwatch", color: "#1E40AF" },
        { name: "Gamma.app", description: "Présentations IA", icon: "gamma", color: "#8B5CF6" }
      ]
    }
  ]

  return (
    <section id="technologies" className="py-24 bg-gradient-to-br from-background to-gray-900/20 relative overflow-hidden">
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <motion.p 
            className="text-text-light text-lg max-w-2xl mx-auto leading-relaxed"
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
        ...
        <div className="space-y-12">
          {technologies.map((category, categoryIndex) => (
            ...
            >
              <motion.h3 
                className="text-2xl font-semibold text-text mb-8 relative inline-block"
              ...
              <div className="flex flex-wrap justify-center gap-3 sm:gap-4 lg:gap-6">
                {category.items.map((tech, index) => (
                  <motion.div
                    key={tech.name}
                    className="dashboard-card text-center group w-28 sm:w-32 lg:w-36 flex-shrink-0 relative overflow-hidden"
                    whileHover={{ 
                      scale: 1.05,
                      y: -8,
                  ...
                  >
                    ...
                    <div className="relative z-10 p-2 sm:p-3 lg:p-4">
                      ...
                      <h4 className="text-xs sm:text-sm font-semibold text-text mb-1 sm:mb-2 group-hover:text-primary transition-colors duration-300">
                        {tech.name}
                      </h4>
                      <p className="text-xs text-text-muted group-hover:text-text-light transition-colors duration-300 leading-relaxed">
                        {tech.description}
                      </p>
                    </div>
