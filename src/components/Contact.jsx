...
const Contact = () => {
  ...
  return (
    <section id="contact" className="py-24 bg-gradient-to-br from-gray-900/20 to-background relative overflow-hidden">
      ...
      <div className="container-custom px-4 sm:px-6">
        ...
        >
          <motion.h2
            ...
            viewport={{ once: true }}
          >
            <span className="text-text">Contactez</span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16">
          ...
          >
            <div>
              <h3 className="text-xl sm:text-2xl font-bold text-text mb-4 sm:mb-6">Informations de contact</h3>
              <p className="text-text-light leading-relaxed mb-6 sm:mb-8 text-sm sm:text-base">
            ...
            <div className="space-y-4 sm:space-y-6">
              {/* Email */}
              <motion.div
                className="flex items-center space-x-3 sm:space-x-4 p-3 sm:p-4 dashboard-card hover:border-red-500/30"
              ...
              >
                ...
                <div>
                  <h4 className="text-text font-semibold text-sm sm:text-base">Email</h4>
                  <a 
                    href="mailto:mehdi.rhanim.37@gmail.com"
                    className="text-text-light hover:text-primary transition-colors duration-300 text-xs sm:text-sm break-all"
                  >
              ...
              {/* Phone */}
              <motion.div
                className="flex items-center space-x-3 sm:space-x-4 p-3 sm:p-4 bg-gray-900/50 rounded-xl border border-gray-800 hover:border-blue-500/30 transition-all duration-300"
                whileHover={{ scale: 1.02 }}
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
              ...
              >
                ...
                <div>
                  <h4 className="text-text font-semibold text-sm sm:text-base">Téléphone</h4>
                  <a 
                    href="tel:+212698773783"
                    className="text-text-light hover:text-primary transition-colors duration-300 text-xs sm:text-sm"
                  >
                    +212 698 773 783
                  </a>
                </div>
              ...
              >
                ...
                <div>
                  <h4 className="text-text font-semibold text-sm sm:text-base">Localisation</h4>
                  <p className="text-text-light text-xs sm:text-sm">Casablanca, Maroc</p>
                </div>
              </motion.div>
            </div>
            ...
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h4 className="text-text font-semibold mb-4">Réseaux sociaux</h4>
              <div className="flex space-x-4">
                <motion.a
                  href="https://linkedin.com/in/mehdi-rhanim"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-12 h-12 bg-gray-800 rounded-full flex items-center justify-center text-text-muted hover:text-primary hover:bg-primary/10 transition-all duration-300"
                  whileHover={{ 
                    scale: 1.1,
                    rotate: 5
                  }}
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h3 className="text-xl sm:text-2xl font-bold text-text mb-4 sm:mb-6">Envoyez-moi un message</h3>
            ...
            <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
              ...
              >
                ...
                <input
                  ...
                  required
                  className="w-full px-3 sm:px-4 py-2 sm:py-3 bg-gray-800 border border-gray-700 rounded-lg text-text placeholder-text-muted focus:border-primary focus:ring-1 focus:ring-primary transition-all duration-300 text-sm sm:text-base"
