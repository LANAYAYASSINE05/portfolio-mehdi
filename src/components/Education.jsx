...
const Education = () => {
  ...
  const education = [
    {
      ...
      description: "Titulaire d'un Master en Marketing et Action Commerciale à l'École Nationale de Commerce et de Gestion. Formation complète en stratégies marketing, gestion commerciale et techniques de vente modernes.",
      highlights: [
  ...
  return (
    <section id="education" className="py-24 bg-gradient-to-br from-background to-gray-900/20 relative overflow-hidden">
      ...
      <div className="container-custom px-4 sm:px-6">
        ...
        >
          <motion.h2
            ...
            viewport={{ once: true }}
          >
            <span className="text-text">Formation &</span>
