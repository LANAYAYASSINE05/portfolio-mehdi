...
const Methodology = () => {
  ...
  return (
    <section id="methodology" className="py-24 bg-gradient-to-br from-background to-gray-900/20 relative overflow-hidden">
      ...
      <div className="container-custom px-4 sm:px-6">
        ...
        >
          <motion.h2
            ...
            viewport={{ once: true }}
          >
            <span className="text-text">Méthodologie de</span>
            <span className="block bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent">
              Travail
            </span>
          </motion.h2>
          <motion.div
            className="w-24 h-1 bg-gradient-to-r from-primary to-accent rounded-full mx-auto mb-8"
            initial={{ width: 0 }}
          ...
          {phases.map((phase, index) => (
            ...
            >
              ...
              >
                ...
                {/* Separator Line */}
                <motion.div
                  className="w-full h-0.5 bg-gradient-to-r from-primary/50 to-accent/50 mb-4"
                  initial={{ width: 0 }}
              ...
              {index < phases.length - 1 && (
                <motion.div
                  className="hidden lg:block absolute top-1/2 -right-4 w-8 h-0.5 bg-gradient-to-r from-primary/50 to-accent/50"
                  initial={{ width: 0 }}
        ...
        >
          <motion.button
            ...
            className="px-8 py-4 bg-primary text-white rounded-lg font-semibold hover:bg-primary/90 transition-all duration-300 flex items-center mx-auto glow-effect"
            whileHover={{ 
              scale: 1.05,
