...
const Skills = () => {
  ...
  return (
    <section id="skills" className="py-24 bg-gradient-to-br from-background to-gray-900/20 relative overflow-hidden">
      ...
      <div className="container-custom px-4 sm:px-6">
        ...
        >
          <motion.h2
            ...
            viewport={{ once: true }}
          >
            <span className="text-text">Compétences</span>
        ...
        {/* Summary */}
        <motion.div
          className="bg-gradient-to-r from-primary/10 to-accent/10 p-8 rounded-2xl border border-primary/20 text-center"
          initial={{ opacity: 0, y: 30 }}
          whileInView={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.8 }}
          viewport={{ once: true }}
        >
          <motion.p
            className="text-text-light text-lg leading-relaxed max-w-4xl mx-auto"
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
        ...
        >
          <motion.button
            ...
            className="px-8 py-4 bg-primary text-white rounded-lg font-semibold hover:bg-primary/90 transition-all duration-300 flex items-center mx-auto gap-3"
            whileHover={{ 
              scale: 1.05,
